...
public class ConsumerSvcHibernateImplTest extends TestCase{
    
    public ConsumerSvcHibernateImplTest() {
    }
	 ...
	 */
        static Logger log = Logger.getLogger(ConsumerSvcHibernateImplTest.class);
